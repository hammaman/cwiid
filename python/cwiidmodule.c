...
static struct {
    ...
    /* AH added new RPT lines for GH */
    CWIID_CONST_MACRO(RPT_GH_GUITAR),
    CWIID_CONST_MACRO(RPT_GH_DRUMS),
    ...
    /* AH added new MESG lines for GH */
    CWIID_CONST_MACRO(MESG_GH_GUITAR),
    CWIID_CONST_MACRO(MESG_GH_DRUMS),
    ...
    /* AH added new EXT lines for GH */
    CWIID_CONST_MACRO(EXT_GH_GUITAR),
    CWIID_CONST_MACRO(EXT_GH_DRUMS),
